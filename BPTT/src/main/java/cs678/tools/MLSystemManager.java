...
//		else if (model.equals("perceptron")) return new Perceptron(rand, 0.1);
//		else if (model.equals("perceptronMultipleOutputs")) return new MultiplePerceptrons(rand);
//		else if (model.equals("neuralnet")) return new NeuralNet(rand);
//		else if (model.equals("decisiontree")) return new DecisionTree();
//		else if (model.equals("knn")) return new InstanceBasedLearner(regression); // set regression 
	...
	public void run(String[] args) throws Exception {
		...
		else if (evalMethod.equals("random"))
		{
			...
			System.out.println("Percentage used for testing: "
			...
			double elapsedTime = System.currentTimeMillis() - startTime;
			System.out.println("Time to train (in seconds): " + elapsedTime
					/ 1000.0);
